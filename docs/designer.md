...
**Mac**:   
* Double click the [Vimdrones Designer-x.x.x.dmg], pull the **Vimdrones Designer icon** to the **Applications file**. Double click the icon to open the Vimdrones Designer
![Vimdrones Desiginer Installation](/static/installation-mac.jpg "Vimdrones Desiginer Installation")  
...
![Vimdrones Desiginer Open Blender](/static/open-blender.jpg "Vimdrones Desiginer Open Blender")
    * Click LOGOUT to logout
    * Click CONSOLE to open the flight check console
* Press **N** to show/hide **Properties**
![Vimdrones Desiginer Open Blender](/static/blender_interface.jpg "Vimdrones Desiginer Open Blender")
...
![Vimdrones Desiginer Geo Basic](/static/geo-basic.png "Vimdrones Desiginer Geo Basic")
...
* Here are three type of the Effector LED:
    * DEFAULT: one color
    * RANDOM: two or more different colors change randomly
    * ORDERED: two or more different colors change smoothly  
![Vimdrones Desiginer Effector](/static/effector-type.png "Vimdrones Desiginer Effector") 
